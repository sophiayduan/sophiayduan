...
- [`dotfiles`](https://github.com/sophiayduan/dotfiles) - _"my fedora rice"_ **(today)**
- [`website`](https://github.com/sophiayduan/website) - _"my personal kicad inspired website"_ **(3 days ago)**
- [`tachometer`](https://github.com/sophiayduan/tachometer) - _"A ESP32 based tachometer with a web dashboard"_ **(3 days ago)**
