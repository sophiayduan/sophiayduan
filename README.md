...
- [`tachometer`](https://github.com/sophiayduan/tachometer) - _"A ESP32 based tachometer with a dashboard"_ **(2 days ago)**
- [`dotfiles`](https://github.com/sophiayduan/dotfiles) - _"my fedora rice"_ **(3 days ago)**
