...
- [`fire-project`](https://github.com/sophiayduan/fire-project) - _""_ **(1 day ago)**
- [`tachometer`](https://github.com/sophiayduan/tachometer) - _"A ESP32 based tachometer with a dashboard"_ **(4 days ago)**
- [`dotfiles`](https://github.com/sophiayduan/dotfiles) - _"my fedora rice"_ **(5 days ago)**
